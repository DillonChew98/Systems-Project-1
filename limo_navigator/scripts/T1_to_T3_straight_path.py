...
def call_server():
    ...
    x = [-4.05,-5.01,-1.90,-2.06,-2.04,-2.10,-3.98,-3.90,-5.06,-5.43,-5.93,-5.86,-5.83,-6.12]
    y = [-2.91,-2.51,-2.51,-2.87,-6.05,-2.53,-2.82,-4.31,-4.35,-4.12,-4.08,-5.06,-5.77,-6.58]

    ori_z = [0.94,0.01,-0.67,-0.66,-0.71,0.99,-0.66,0.99 ,0.92,0.99,-0.74,-0.66,-0.86,-0.67]
    ori_w = [0.33,0.99,0.73 , 0.74,0.69 ,0.04,0.74 ,-0.04,0.37,0.07,0.66,0.74,0.50,0.74]

    # x = [-4.05,-5.01,-2.21,-2.06]
    # y = [-2.91,-2.51,-2.57,-2.87]

    # ori_z = [0.94,0.01,-0.65,-0.66]
    # ori_w = [0.33,0.99,0.76 , 0.74]
